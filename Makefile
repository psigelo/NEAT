...
test_genetic_encoding: genetic_encoding.o test_genetic_encoding.cpp function.o
	@$(CC) $(CFLAGS)  ./src/test_genetic_encoding.cpp ./objects/genetic_encoding.o ./objects/function.o -o ./executables/$@

test_NEAT: test_NEAT.cpp NEAT.o  genetic_encoding.o fitness.o 
	@$(CC) $(CFLAGS) ./objects/function.o ./src/test_NEAT.cpp ./objects/NEAT.o ./objects/genetic_encoding.o ./objects/fitness.o -o ./executables/NEAT_test
